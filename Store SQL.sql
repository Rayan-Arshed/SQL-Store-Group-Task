...
USE store;
-- Task 1: Show customer names for all of the orders
SELECT first_name, last_name, orders.*
FROM customers INNER JOIN orders 
ON customers.customer_id = orders.customer_id;

-- Task 2:  Show customer names for all of the orders, including customers who haven't placed orders
SELECT first_name, last_name, orders.*
FROM customers LEFT JOIN orders 
ON customers.customer_id = orders.customer_id;

-- Additional Task: Show customers who have placed orders using subquery
SELECT *
FROM customers
